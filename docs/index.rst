...
.. note:: 本文档是对Pillow官方文档的中文翻译。译者：phyng(`Github <https://github.com/phyng>`_)开始于2014-05-21。

.. warning:: 受限于译者英文水平以及技术水平以及英文到中文的习惯转换，译文难免有很多别扭甚至错误的地方，只能作为大致参考，请尽量RTFEM（Read The Fucking English Manual）。
...
.. note:: 上面一排图片无法显示第四个的话考虑下墙。

使用 Pillow 前先阅读 :doc:`安装说明 <installation>`.

你可以从 Pillow 的 Github 获取源码或者做出贡献
https://github.com/python-imaging/Pillow. 你也可以从 `PyPI <https://pypi.python.org/pypi/Pillow>`_ 下载。
